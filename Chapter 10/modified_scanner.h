 ...
 * -----------------------------
 * This function returns the desired token on the line.
 */
 ...
 * Usage: token = ReturnUppercaseTokens(token) . . .
 * -------------------------------------------------
...
/*
 * Function: isdigiop
 * Usage: if(isdigiop(ch)) . . .
 * -----------------------------
 * This function determines whether a char is an operator.
 */
